...
$i++;
$cfg['Servers'][$i]['host'] = 'mysql-service'; //If you don't have the IP address, you can directly enter the hostname of remote server
...
$cfg['Servers'][$i]['password'] = 'root'; //Password associated with the username specified above
